...
<?php foreach ($products as $product): ?>
    <div class="product">
        ...
        <form method="POST" action="index.php?page=admin">
            ...
            <label>Name:</label><input type="text" name="name" value="<?php echo htmlspecialchars($product['name']); ?>"><br>
            ...
            <label>Discount:</label><input type="number" step="0.01" name="discount" value="<?php echo $product['discount']; ?>"><br>
            <label>Image URL:</label><input type="url" name="image_url" value="<?php echo htmlspecialchars($product['image_url']); ?>"><br>
