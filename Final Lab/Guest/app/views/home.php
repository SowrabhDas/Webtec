...
<link rel="stylesheet" href="<?php echo defined('BASE_URL') ? BASE_URL : '/sawrob/public/'; ?>CSS/products.css">
...
<div id="products">
    <?php foreach ($products as $product): ?>
     ...
     alt="<?php echo htmlspecialchars($product['name']); ?>" width="200">
            ...
            <p>Price: $<?php echo $product['price']; ?> (Discount: $<?php echo $product['discount']; ?>)</p>
