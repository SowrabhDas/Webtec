...
<div class="container auth-container">
  <div class="auth-card">
    ...
    <form method="POST" action="?page=register" onsubmit="return validateRegister()" class="auth-form">
      ...
      <div class="form-row">
        <label>DOB:</label>
        <input type="date" name="dob" value="<?php echo htmlspecialchars($_POST['dob'] ?? '', ENT_QUOTES); ?>">
      </div>
      ...
      <div class="form-row">
        <label>Address:</label>
        <textarea name="address"><?php echo htmlspecialchars($_POST['address'] ?? '', ENT_QUOTES); ?></textarea>
      </div>
